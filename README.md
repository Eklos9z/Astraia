...
An Android Studio project is available in `android/`. It builds a small native
Android app around the Edax engine through JNI.

Before building, copy Edax's `eval.dat` to:

```sh
android/app/src/main/assets/data/eval.dat
```
